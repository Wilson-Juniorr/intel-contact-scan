...
export const AUDIO_TRIGGERS = [
  {
    ...
    script_sugerido: `Oi… Aqui é o Junior mesmo. Sou consultor de planos de saúde, trabalho com as principais operadoras. Vou te ajudar a achar a melhor opção pro seu perfil. Me conta mais…`,
    duracao_ideal: "8-12s",
  },
  {
    ...
    script_sugerido: `Perfeito… Já entendi sua situação. Com esses dados eu já consigo montar as opções certas pra você, sem desperdiçar seu tempo. Já estou verificando…`,
    duracao_ideal: "8-12s",
  },
  {
    ...
    script_sugerido: `Oi! Já tenho tudo que precisava. Vou montar as melhores opções pro seu perfil agora e te mando ainda hoje. Qualquer dúvida pode falar!`,
    duracao_ideal: "8-10s",
  },
  {
    ...
    script_sugerido: `Oi! Aqui é o Junior. Vi que a gente estava conversando sobre o plano. Fica à vontade pra continuar quando puder, tô aqui.`,
    duracao_ideal: "6-8s",
  },
  {
    ...
    script_sugerido: `Oi! Junior aqui. Tô com algumas novidades de tabela que podem ser interessantes pro seu perfil. Quando quiser continuar é só falar.`,
    duracao_ideal: "8-10s",
  },
] as const;
