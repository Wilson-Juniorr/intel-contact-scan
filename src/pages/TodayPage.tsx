  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex gap-3 flex-wrap">
        <Badge
          variant="outline"
          className="text-sm px-3 py-1 gap-1.5 bg-destructive/10 text-destructive border-destructive/30"
        >
          <AlertTriangle className="h-3.5 w-3.5" /> {atrasados.length} atrasados
        </Badge>
        <Badge
          variant="outline"
          className="text-sm px-3 py-1 gap-1.5 bg-yellow-500/10 text-yellow-600 border-yellow-500/30"
        >
          <Clock className="h-3.5 w-3.5" /> {hoje.length} para hoje
        </Badge>
        <Badge
          variant="outline"
          className="text-sm px-3 py-1 gap-1.5 bg-emerald-500/10 text-emerald-600 border-emerald-500/30"
        >
