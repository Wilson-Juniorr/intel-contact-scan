...
function GeneralDocsSectionFullscreen({
  documents,
  docCategory,
  setDocCategory,
  fileRef,
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Button
              asChild
              size="sm"
              className="w-full gap-2 bg-secondary hover:bg-secondary/90 text-secondary-foreground h-8 text-xs"
            >
                ...
                <div className="space-y-2 p-2.5 rounded-lg border border-border bg-muted/30">
                  <div className="flex items-center justify-between">
                    ...
                    {responseRate > 0 && (
                      <Badge
                        ...
                        className="text-[10px]"
                        style={{
                          color: responseRate > 50 ? "hsl(140, 70%, 40%)" : "hsl(35, 85%, 50%)",
                        }}
                      >
                        {responseRate}% resp.
                      </Badge>
                  ...
                  <div className="h-2 rounded-full bg-muted overflow-hidden">
                    <div
                      ...
                      style={{
                        width: `${pct}%`,
                        backgroundColor: isComplete ? "hsl(140, 70%, 40%)" : stageInfo?.color,
                      }}
                    />
                  </div>
                  <p className="text-[10px] text-muted-foreground">
                    {isComplete
                      ? "✅ Meta de 6 dias atingida"
                      : `Faltam ${goal - progress} dia(s) de contato`}
                  </p>
                </div>
              );
            })()}
        ...
        <div className="space-y-3">
          ...
          {obs.documents.length > 0 && (
            <Button
              size="sm"
              variant="outline"
              className="w-full h-7 gap-1.5 text-[11px] border-secondary/30 text-secondary hover:bg-secondary/10"
          ...
          <div className="space-y-3 max-h-[500px] overflow-y-auto pr-1">
            ...
            <GeneralDocsSectionFullscreen
              ...
              onDeleteDoc={(doc: any) =>
                obs.deleteDocument({ id: doc.id, file_path: doc.file_path })
              }
            />
            <MemberSection
              role="titular"
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-1.5">
              ...
              />
              <Button size="sm" variant="ghost" onClick={addTag} className="h-7 px-1.5">
              ...
              <div className="flex flex-wrap gap-1">
                {noteTags.map((t) => (
                  <Badge
                    ...
                    onClick={() => setNoteTags((p) => p.filter((x) => x !== t))}
                  >
            ...
            <div className="space-y-1.5 max-h-[200px] overflow-y-auto pr-1">
              {filteredNotes.length === 0 && (
                <p className="text-xs text-muted-foreground text-center py-2">Nenhuma nota</p>
              )}
              {filteredNotes.map((note: any) => (
                <div
                  key={note.id}
                  className="p-2 rounded-lg border border-border bg-card space-y-1"
                >
                  <div className="flex items-center justify-between">
          ...
          <div className="space-y-2">
            ...
            <div className="space-y-2 max-h-[200px] overflow-y-auto pr-1">
              {interactions.length === 0 && (
                <p className="text-xs text-muted-foreground text-center py-2">Nenhuma interação</p>
              )}
    ...
    <div className="flex items-center justify-between w-full">
      ...
      <div className="flex items-center gap-1">
        ...
        <Button
          ...
          title={isFullscreen ? "Painel lateral" : "Tela cheia"}
        >
